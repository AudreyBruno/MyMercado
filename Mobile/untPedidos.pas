...
begin
  AddPedidoLv(1, 5, 'Pão de Açucar 1', 'Av. Paulista, 2689', '21/01/2023', 50);
  AddPedidoLv(2, 4, 'Pão de Açucar 2', 'Av. Paulista, 2689', '22/01/2023', 40);
  AddPedidoLv(3, 3, 'Pão de Açucar 3', 'Av. Paulista, 2689', '23/01/2023', 30);
  AddPedidoLv(4, 2, 'Pão de Açucar 4', 'Av. Paulista, 2689', '24/01/2023', 20);
  AddPedidoLv(5, 1, 'Pão de Açucar 5', 'Av. Paulista, 2689', '25/01/2023', 10);
end;
